...
const highlights = [
  { label: "Location", value: "Vrindavan, UP" },
  { label: "Project Type", value: "Residential Retreat" },
  { label: "Offerings", value: "Premium Homes" },
  { label: "Status", value: "Upcoming" },
];

const features = [
  "Set in the sacred & serene city of Vrindavan, Uttar Pradesh",
  "Premium residential homes blending spirituality with modern comfort",
  "Lush green surroundings with peaceful, pollution-free environment",
  "Excellent connectivity to Mathura, Agra & Delhi via expressway",
  "World-class amenities including clubhouse & landscaped gardens",
  "Ideal for both permanent residency and weekend/retirement homes",
];

export default function HauteResidency() {
  return (
    <>
      <Navbar />
      ...
      >
        ...
        >
          ...
          >
            ...
            <a href="tel:+917005008600" className="btn-outline">
              Call Us Now
            </a>
          </div>
        </div>
      ...
      <section
        ...
        aria-labelledby="hr-about-heading"
      >
        ...
        <div className="container" style={{ position: "relative", zIndex: 1 }}>
          <div className="hr-about-grid">
            ...
            <div>
              ...
              <h2 id="hr-about-heading" style={{ color: "#fff", fontSize: "clamp(1.8rem, 2.8vw, 2.5rem)", lineHeight: 1.15, marginBottom: "0.5rem" }}>
                Sacred Serenity Meets{" "}
                <em style={{ color: "var(--gold)", fontStyle: "italic" }}>Modern Living</em>
              </h2>
      ...
      {/* ── NOTIFY / CTA STRIP ── */}
      <section style={{ background: "var(--cream)", padding: "5rem 0", position: "relative", overflow: "hidden" }} aria-labelledby="hr-notify-heading">
        ...
        <div className="container" style={{ position: "relative", zIndex: 1 }}>
          <div style={{ background: "linear-gradient(135deg, var(--forest-dark) 0%, var(--forest) 100%)", borderRadius: "20px", padding: "4rem", textAlign: "center", position: "relative", overflow: "hidden", border: "1px solid rgba(201,144,26,0.2)" }}>
            ...
            <h2 id="hr-notify-heading" style={{ color: "#fff", fontSize: "clamp(1.8rem, 3vw, 2.6rem)", lineHeight: 1.2, margin: "0.5rem 0 1rem" }}>
              Don't Miss the{" "}
            ...
            <div style={{ display: "flex", gap: "1rem", justifyContent: "center", flexWrap: "wrap" }}>
              ...
              <a href="tel:+917005008600" className="btn-outline">+91 70050 08600</a>
            </div>
