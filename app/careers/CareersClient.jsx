...
/* ── Scroll-reveal wrapper (matches Expressway page behavior) ── */
function RevealItem({ className = "", children }) {
  ...
  return (
    <div
      ref={ref}
      className={`${className} careers-block-anim${inView ? " careers-inview-item" : ""}`}
    >
      {children}
    </div>
  );
...
const roles = [
  ...
  },
  {
    ...
    location: "Sector 63, Noida",
    exp: "7–12 Years",
    desc: "Looking for an experienced and result-oriented real estate professional to lead sales operations and drive business growth. The ideal candidate should possess strong leadership, strategic planning, communication, negotiation, and client management skills, with the ability to manage sales teams, handle high-value clients, achieve revenue targets, and develop strategies to maximize business performance.",
    skills: [
      "Real Estate Sales",
...
const perks = [
  {
    ...
    desc: "Industry-leading salaries with performance-linked incentives and annual bonuses.",
  },
  {
    Icon: IconTrendingUp,
    title: "Growth Path",
    desc: "Clear career progression with mentorship from senior leadership and industry experts.",
  },
  {
    Icon: IconHome,
    title: "Employee Discounts",
    desc: "Special pricing on Haute properties for employees and their families.",
  },
  {
    Icon: IconGraduationCap,
    title: "Learning & Development",
    desc: "Sponsored certifications, real estate training programs and skill workshops.",
  },
  {
    Icon: IconUsers,
    title: "Collaborative Culture",
    desc: "A team that celebrates wins together — open-door leadership and flat hierarchy.",
  },
  {
    Icon: IconMapPin,
    title: "Prime Work Location",
    desc: "Modern office in Sector 63, Noida — well connected and vibrant work environment.",
  },
];
...
const coreValues = [
  {
    ...
    desc: "We operate with complete transparency — with clients, partners and our team.",
  },
  {
    Icon: IconRocket,
    title: "Ambition & Growth",
    desc: "We encourage every team member to think big, take ownership, and grow boldly.",
  },
  {
    Icon: IconLeaf,
    title: "Sustainable Impact",
    desc: "Every project we build is designed to enrich communities and improve lives.",
  },
  {
    Icon: IconHandshake,
    title: "Customer Obsession",
    desc: "From site visit to possession, our clients experience world-class service.",
  },
];
  ...
  return (
    <>
      ...
      <section
        ...
        aria-label="Careers at Haute World Developers"
      >
        <img
        ...
        <div className="careers-hero-bottom">
          ...
          <a href="/" className="careers-hero-home">
            ← HOME
          </a>
        </div>
      </section>
      ...
      {/* ── ABOUT WORKING HERE ── */}
      <section
        className="careers-about"
        aria-labelledby="careers-about-heading"
      >
        <div className="container">
          <div className="careers-about-grid">
            <div>
              ...
              <p>
                At Haute World Developers, we strongly believe that a home is
                the most precious asset for anyone. Since 2011, we have been
                building modern, safe, secure and compassionate communities —
                delivering ZEN living experiences through innovative design and
                sustainable infrastructure.
              </p>
              <p style={{ marginTop: "1rem" }}>
                From premium plotted developments in Noida to India's first
                AI-enabled township on the Delhi–Meerut Expressway, every Haute
                project reflects our commitment to quality, transparency, and
                community living. We operate across 6+ cities including Noida,
                Ghaziabad, Greater Noida, Dehradun, Vrindavan and Dholera.
              </p>
              <p style={{ marginTop: "1rem" }}>
                When you join Haute World Developers, you join a culture that
                values integrity, ownership, and ambition. Our people are our
                greatest asset — and we invest in them as much as we invest in
                our projects.
              </p>
            </div>
            ...
            <div className="careers-values">
              ...
              {coreValues.map((v) => (
                <RevealItem className="careers-value-card" key={v.title}>
      ...
      <section className="careers-perks" aria-labelledby="perks-heading">
        <div className="container">
          <div style={{ textAlign: "center", maxWidth: 540, margin: "0 auto" }}>
            ...
            <h2 id="perks-heading" style={{ color: "var(--white)" }}>
              What We Offer
            </h2>
          ...
          <div className="careers-perks-grid">
            {perks.map((p) => (
              <RevealItem className="careers-perk-card" key={p.title}>
        ...
        <div className="container">
          <div style={{ textAlign: "center", maxWidth: 560, margin: "0 auto" }}>
            ...
            <p style={{ color: "var(--gray)", fontSize: "0.95rem" }}>
              ...
              <a
                href="mailto:hr@hautedevelopers.com"
                style={{ color: "var(--gold)", fontWeight: 600 }}
              >
                {" "}
                hr@hautedevelopers.com
              </a>
            </p>
          </div>
          <div className="careers-roles-list" role="list">
            {roles.map((role, i) => (
              ...
              >
                ...
                <p className="careers-role-desc" itemProp="description">
                  {role.desc}
                </p>
                ...
                <div className="careers-role-skills">
                  {role.skills.map((s) => (
                    <span className="careers-skill-tag" key={s}>
                      {s}
                    </span>
                  ))}
                </div>
      ...
      <section
        ...
        aria-label="Apply to Haute World Developers"
      >
        <div className="container">
          <div className="careers-cta-inner">
            <div>
              ...
              <p>
                We're always on the lookout for talented, driven professionals.
                Tell us about yourself and the role you think you'd excel in —
